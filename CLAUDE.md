...
A property viewing tracker for a real estate admin clerk to replace spreadsheet + WhatsApp — tracking clients, properties, and viewing appointments with status and result, viewable without login in v1.
